(() => {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\search\search.ts
  ...
  // ns-params:@params
  var params_default = { fuse: { ignoreLocation: true, minMatchCharLength: 3 }, maxResults: 100, paginate: 10, resultContentWordCount: 240 };

  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\search\engine.ts
  var Engine = class {
    fuse;
    pages = [];
    indices = [];
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\search\form.ts
  var Form = class {
    constructor(form, callback) {
      this.form = form;
