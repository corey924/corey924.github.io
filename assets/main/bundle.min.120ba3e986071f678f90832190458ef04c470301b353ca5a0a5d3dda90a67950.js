(() => {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\snackbar\index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\actions-panel\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\app\index.ts
  var App = class {
    constructor() {
  ...
  // ns-params:@params
  var params_default = { author: { avatar: "images/profile.jpg", bio: "Freelance | Full-Stack Developer | Web Development Project Manager", location: "<a href='https://www.openstreetmap.org/relation/449220' target='_blank'>Taiwan</a>", name: "Corey", social: { facebook: "corey924", github: "corey924", instagram: "corey.924", linkedin: "corey-ko-6957ba70", rss: "", youtube: "UCfAFaiB3ozsLYLCkeU1IJiQ" } }, baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false, maxlines: 20 }, color: "auto", counttaxonomyposts: true, creativecommons: { by: true, nc: true, nd: true }, customcss: [], customjs: [], dateformat: "2006-01-02", diagram: false, docs: { nav: { expand: false } }, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, logo: "images/logo.webp", mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { excerpt: "description", excerptmaxlength: 120, featuredimage: true, imagetitleascaption: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { precache: {} }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", search: { fuse: { minmatchcharlength: 3 }, indexpaginate: 100 }, searchbar: false, sidebartaxonomies: ["series", "categories", "tags", "authors"], socialshare: false, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, viewer: true };

  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\code\code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\code\index.ts
  var Code = class {
    run() {
      document.addEventListener("DOMContentLoaded", () => {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\docs\catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\docs\index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\font-size-selector\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\form-validator\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\iframe\index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\loading-bar\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\scroller\index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\sidebar-toggle\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\table-wrapper\index.ts
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\toc\index.ts
  var TOC = class {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\rss\index.ts
  var RSS = class {
    run() {
      if (true) {
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\main\js\components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\slide\index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:D:\Project\Other\Blog\CoreyBlog\themes\hugo-theme-bootstrap\assets\js\search\index.ts
  (() => {
    "use strict";
    var _a, _b;
