(() => {
  ...
  // ns-params:@params
  var params_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false, maxlines: 10 }, color: "auto", counttaxonomyposts: true, creativecommons: { by: true, nc: true, nd: true }, customcss: [], customjs: [], dateformat: "2006-01-02", diagram: false, docs: { nav: { expand: false } }, featuredpostcount: 5, fixedheader: true, fullwidth: false, logo: "images/logo.webp", mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { excerpt: "description", excerptmaxlength: 120, featuredimage: true, imagetitleascaption: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { precache: {} }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, search: { fuse: { minmatchcharlength: 3 }, indexpaginate: 100 }, searchbar: false, sidebartaxonomies: ["series", "categories", "tags", "authors"], socialshare: false, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, viewer: true };
